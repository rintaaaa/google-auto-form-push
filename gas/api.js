const API_SECRET = 'google-form-rpa-2026-local-secret';

// TODO:変更してください。取得元スプレッドシート
const SOURCE_SPREADSHEET_ID = 'SOURCE_SPREADSHEET_ID';
const SOURCE_SHEET_NAME = 'work';

// TODO:変更してください。実行側スプレッドシート
const DEST_SPREADSHEET_ID = 'DEST_SPREADSHEET_ID';

// 実行側スプレッドシートに作成しておくテンプレートシート名
// このシートにヘッダー順、ステータス列のプルダウンチップ、列幅、固定行、日付形式、罫線などを設定しておく
const TEMPLATE_SHEET_NAME = 'template';

// TODO:変更してください。Formリンク
const AUTO_FORM_URL = 'https://docs.google.com/forms/d/e/sample/viewform';
